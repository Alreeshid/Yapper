      ...
      <section>
        <div className="container mx-auto px-6 py-12">
          <div className="text-center">
            <p className="text-primary-500 dark:text-primary-400 font-medium"> Contact us </p>
            <h2 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white"> Get in touch </h2>
            <p className="mt-3 text-gray-500 dark:text-gray-400">I'm always willing to answer questions and </p>
          </div>
          <div className="mt-10 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
              <span className="bg-primary-100/80 text-primary-500 rounded-full p-3 dark:bg-gray-800">
                <span className="w-24px h-24px h-6 w-6">
                  <svg
                    className="w-[inherit] h-[inherit]"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-primary-500 dark:text-primary-400 mt-2"> hello@merakiui.com </p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <span className="bg-primary-100/80 text-primary-500 rounded-full p-3 dark:bg-gray-800">
                <span className="w-24px h-24px h-6 w-6">
              ...
              <p className="text-primary-500 dark:text-primary-400 mt-2"> 100 Smith Street Collingwood VIC 3066 AU </p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <span className="bg-primary-100/80 text-primary-500 rounded-full p-3 dark:bg-gray-800">
                <span className="w-24px h-24px h-6 w-6">
              ...
              <p className="text-primary-500 dark:text-primary-400 mt-2"> +1 (555) 000-0000 </p>
            </div>
          </div>
        </div>
        </section>
