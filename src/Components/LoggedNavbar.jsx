    ...
    return(
      ...
      {/*<nav className="bg-white shadow dark:bg-gray-800 w-screen">
        <div className="container mx-auto flex items-center justify-center p-6 capitalize text-gray-600 dark:text-gray-300 xl:px-[40px]">
          <a
            href="#"
            className="hover:border-primary-500 mx-1.5 transform border-b-2 border-transparent transition-colors duration-300 hover:text-gray-800 sm:mx-6 dark:hover:text-gray-200">
          ...
          <a
            className="border-primary-500 mx-1.5 transform border-b-2 text-gray-800 transition-colors duration-300 sm:mx-6 dark:text-gray-200"
            href="#"
            target="_self">
            Dashboard
          </a>
          ...
          <a
            className="hover:border-primary-500 mx-1.5 transform border-b-2 border-transparent transition-colors duration-300 hover:text-gray-800 dark:hover:text-gray-200 font-extrabold float-right sm:mx-6"
            href="#"
            target="_self">
            Sign Out
          </a>
