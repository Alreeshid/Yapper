                ...
                <div className="container grid grid-cols-12 mx-auto dark:bg-gray-50">
                    ...
                    <div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
                        <div className="flex justify-start">
                            <span className="px-2 py-1 text-xs rounded-full dark:bg-violet-600 dark:text-gray-50">{data.type}</span>
                        </div>
                        <h1 className="text-3xl font-semibold">{data.title}</h1>
                        <p className="flex-1 pt-2">{data.shortDesc}</p>
                        <a rel="noopener noreferrer" href={data.href} className="inline-flex items-center pt-2 pb-6 space-x-2 text-sm dark:text-violet-600">
                            <span>Read more</span>
                        ...
                        <div className="flex items-center justify-between pt-2">
                            ...
                            <span className="text-xs">{data.readTime}</span>
                        </div>
                    </div>
                </div>
            </div>  
